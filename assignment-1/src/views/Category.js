  ...
  return (
          ...
          <MDBJumbotron style={{ padding: 0 }}>
            <MDBCol className="text-white text-center py-1 px-1 my-1" style={{ backgroundImage: `url(https://mdbootstrap.com/img/Photos/Others/gradient1.jpg)` }}>
              <MDBCol className="py-5">
                <MDBCardTitle className="h1-responsive pt-3 m-5 font-bold">All Categories</MDBCardTitle>
              </MDBCol>
            </MDBCol>
          </MDBJumbotron>
        </MDBCol>
    ...
    <MDBContainer className='mw-100' style={{ margin: 0, height:'10px' }}>
      <MDBBreadcrumb light color="peach-gradient lighten-2">
        ...
        <MDBBreadcrumbItem iconRegular icon="star" active>All Categories</MDBBreadcrumbItem>
      </MDBBreadcrumb>
    </MDBContainer>
    {/* Content*/}
    ...
    <MDBContainer className='mw-100 category-2'>
        <BestSellers />
    </MDBContainer>
    </div>
    </>
